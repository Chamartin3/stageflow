...
class TestProcess:
    ...
    Note: This class now uses fixtures from conftest.py for process definitions.
    See simple_two_stage_process and multi_stage_onboarding_process fixtures.
    """
    ...
    def test_process_initialization_with_valid_config(self, simple_two_stage_process):
    ...
    def test_process_initialization_with_invalid_final_stage_raises_error(
        ...
        # Arrange
        simple_two_stage_process["final_stage"] = "nonexistent"
    ...
    def test_process_initialization_with_duplicate_stage_names_raises_error(
        ...
        simple_two_stage_process["stages"]["duplicate"] = simple_two_stage_process["stages"][
            "start"
        ].copy()
        simple_two_stage_process["stages"]["duplicate"]["name"] = "Duplicate Stage"
    ...
    def test_process_get_stage_by_name(self, simple_two_stage_process):
    ...
    def test_process_consistency_issues_property(self, simple_two_stage_process):
    ...
    def test_process_evaluate_with_valid_element_at_initial_stage(
        self, simple_two_stage_process, valid_user_element
    ):
    ...
    def test_process_evaluate_with_regression_detection(
        ...
        # Arrange
        process = Process(multi_stage_onboarding_process)
    ...
    def test_process_remove_initial_stage_raises_error(self, simple_two_stage_process):
    ...
    def test_process_remove_final_stage_raises_error(self, simple_two_stage_process):
    ...
    def test_process_remove_nonexistent_stage_raises_error(self, simple_two_stage_process):
    ...
    def test_process_add_transition_updates_checker(self, simple_two_stage_process):
    ...
    def test_process_serialization_to_dict(self, simple_two_stage_process):
    ...
    def test_process_path_finding_methods(self, multi_stage_onboarding_process):
